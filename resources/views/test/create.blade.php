...
<form method="post" action="{{route('test.store')}}">
	...
	<div class="col-md-6 col-lg-6 col-sm-6 col-lg-offset-3">
	  <div class="form-group">
	    <label class="col-form-label" for="formGroupExampleInput">Test ID</label>
	    <input type="text" name="test_id" class="form-control " id="formGroupExampleInput" placeholder="E.g. 11122333" required>
	  </div>
	  <div class="form-group">
	    <label class="col-form-label" for="formGroupExampleInput2">Quiz Code</label>
	    <input type="text" name="quiz_code" class="form-control" id="formGroupExampleInput2" placeholder="E.g. A6xgP" required>
	  </div>
