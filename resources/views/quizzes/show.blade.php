...
<div class="container">
	<a href="{{ url('/quizzes') }}" class="btn btn-info btn-sm" role="button" aria-pressed="true">Back</a>
	<hr>
	<div class="card p-3 shadow-lg border-0 mb-4 bg-white rounded">
		<div class="card-header font-weight-bold border-0 bg-transparent">{{ $quiz->title }}</div>
		<div class="card-body">
