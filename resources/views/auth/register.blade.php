    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card p-3 shadow-lg border-0 mb-5 bg-white rounded">
                <div class="card-headerborder-0 bg-white text-dark font-weight-bold">{{ __('Register') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="education_level"  required data-validation-required-message= "education_level is required">
                                    <option value="">--select education_level--</option>
                                    <option value="Secondary School Leaver">Secondary School Leaver</option>
